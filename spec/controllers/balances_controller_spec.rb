  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved balance as @balance" do
        ...
        post :create, {:balance => { "type" => "invalid value" }}, valid_session
        assigns(:balance).should be_a_new(Balance)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested balance" do
        ...
        Balance.any_instance.should_receive(:update_attributes).with({ "type" => "" })
        put :update, {:id => balance.to_param, :balance => { "type" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the balance as @balance" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Balance.any_instance.stub(:save).and_return(false)
        put :update, {:id => balance.to_param, :balance => { "type" => "invalid value" }}, valid_session
        assigns(:balance).should eq(balance)
      end
